...
return {
  {
    ...
    config = function()
      ...
      local comment = require('utils.misc').get_hl_color('@comment', 'fg')

      vim.api.nvim_set_hl(0, 'TelescopeNormal', { fg = fg, bg = border.bg })
      vim.api.nvim_set_hl(0, 'TelescopeBorder', { fg = border.bg, bg = border.bg })
      vim.api.nvim_set_hl(0, 'TelescopeResultsNormal', { fg = fg, bg = border.bg })
      vim.api.nvim_set_hl(0, 'TelescopeResultsBorder', { fg = border.bg, bg = border.bg })
      vim.api.nvim_set_hl(0, 'TelescopePreviewNormal', { fg = fg, bg = cursorline })
      vim.api.nvim_set_hl(0, 'TelescopePreviewBorder', { fg = cursorline, bg = cursorline })
      vim.api.nvim_set_hl(0, 'TelescopePromptNormal', { bg = comment, fg = cursorline, bold = true })
      vim.api.nvim_set_hl(0, 'TelescopePromptBorder', { fg = comment, bg = comment })
      vim.api.nvim_set_hl(0, 'TelescopePromptCounter', { fg = cursorline, bold = true })
